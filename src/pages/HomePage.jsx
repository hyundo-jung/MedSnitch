  ...
  return (
    <>
        ...
        <img src={flowchart} className="flowchart"></img>
          {/* <Circle num="1" color="#B6FFDA" text="Log In" top="50px" left="50%"/> 

          <Circle num="2" color="#BEDAF7" text="Upload Claims" top="325px" left="80%"/>
          <div className="arrow">
            <svg xmlns="http://www.w3.org/2000/svg" width="114" height="100" viewBox="0 0 114 95" fill="none">
          ...
          <Circle num="5" color="#E4BEF7" text="Save History"  top="325px" left="20%"/>
